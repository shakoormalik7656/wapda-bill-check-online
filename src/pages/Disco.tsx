...
import { DISCO_DATA } from '../content/discoData';
...
export default function Disco() {
  ...
  useSEO({
    title: discoInfo
      ? `${discoInfo.name} Online Bill Check 2026 | Check Duplicate Electricity Bill`
      : 'WAPDA Online Bill Check | Check Duplicate Electricity Bill Pakistan',
    description: discoInfo
      ? `Check your duplicate ${discoInfo.fullName} (${discoInfo.name}) electricity bill online. Get your latest WAPDA bill for ${discoInfo.name} easily and securely.`
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: `${discoInfo!.name} Online Bill Check`,
        item: `https://www.wapdaonlinebillcheck.com/${discoInfo!.id}`,
      },
    ],
  };
